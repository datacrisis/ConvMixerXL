...
testvalset = torchvision.datasets.CIFAR100(root='./data', train=False,
...
if args.model == 'CM':
    model = ConvMixer(args.hdim, args.depth, patch_size=args.psize, kernel_size=args.conv_ks, n_classes=100, activation=args.activation)
elif args.model == 'CM-XL':
    model = ConvMixerXL(args.hdim, args.depth, patch_size=args.psize, kernel_size=args.conv_ks, n_classes=100, skip_period=args.skip_period, activation=args.activation)
